...
public class NominatedCandidatesController {
	...
	@GetMapping(value="viewbycandidateid/{candidateId}",produces="application/json")
	...
	@PutMapping(value = "/update/{candidateId}",produces="application/json")
	public ResponseEntity<HttpStatus> modifyNominatedCandidate(@PathVariable("candidateId") Integer candidateId,@RequestBody NominatedCandidates candidate)
	{
		boolean a=false;
